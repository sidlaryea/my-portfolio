...
<div><img src="images/pic.PNG" className="rounded-full w-50 h-50 mx-auto" /> </div>
...
<a href="CV.pdf" download className=" border border-blue-500/50 text-blue-500 py-3 px-6 rounded 
